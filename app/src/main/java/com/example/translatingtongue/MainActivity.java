package com.example.translatingtongue;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        translateBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(sourceEdt.getText().toString().isEmpty()){
                    ...
                    Toast.makeText(MainActivity.this, "Please select second language", Toast.LENGTH_SHORT).show();
                }else{
        ...
        micIV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra(RecognizerIntent.EXTRA_PROMPT,"Speak for text");
                try{
...
//    String[] toLanguages={"To","English","Afrikaans","Arabic","Belarusian","Bulgarian","Bengali","Catalan","Czech"
//            ,"Welsh","Hindi","Urdu","Russian","Portuguese","French","Spanish"};
